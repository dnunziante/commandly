...
export default async function CoachScenariosPage() {
  ...
  return <AppShell title="Practice Scenarios"><PageHeader eyebrow="Scenario library" title="Choose a customer conversation to practice" description={result.source === "demo" ? "Each exercise uses temporary BGC sample content while local demo mode is active." : "Each exercise is approved for your workspace and stored securely in Supabase."}/>

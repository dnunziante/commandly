...
export default async function GrowthAdvisorPage() {
  ...
  return <AppShell title="Business Growth Advisor">
    ...
    <div className="callout growth-disclaimer"><Lightbulb size={20}/><div><strong>Planning insights</strong><p>These are simulated BGC examples for planning the experience. They are not based on live market data, verified demand, or AI analysis.</p></div></div>

...
export default async function KnowledgeBasePage() {
  ...
  return <AppShell title="Knowledge Base">
    <PageHeader eyebrow="Approved team knowledge" title="Keep every answer grounded" description="Private source files are securely indexed so the Sales Assistant can answer from approved Refyntra knowledge." action={canManage ? <Link className="btn btn-primary" href="/admin/training">Build a module</Link> : null}/>

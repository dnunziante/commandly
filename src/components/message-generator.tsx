...
function TextGenerator({ productOptions }: { productOptions: string[] }) {
  ...
  return <AppShell title="Write a Text"><PageHeader eyebrow="AI message studio" title="Write a customer-ready sales text" description="Create a concise, personal message grounded in your conversation and approved Refyntra data."/><div className="grid grid-2 email-generator-layout"><form className="card form-stack" onSubmit={generate}>

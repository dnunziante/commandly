...
export const products: Product[] = [
  { id: "demo-nexus", slug: "nexus-4-passenger-forward", name: "Nexus", model: "4 Passenger Forward", price: 15995, status: "Published", description: "Premium 72V performance with upscale comfort and connected technology.", range: "Up to 55 mi", seats: "4 passengers", highlights: ["72V lithium", "Power steering", "10.1-in touchscreen"], color: "navy" },
  { id: "demo-beyond", slug: "beyond-4-passenger-forward", name: "Beyond", model: "4 Passenger Forward", price: 13495, status: "Published", description: "A refined everyday cart with practical premium features included.", range: "Up to 40 mi", seats: "4 passengers", highlights: ["48V lithium", "Aluminum frame", "Premium audio"], color: "blue" },
  { id: "demo-pulse", slug: "activev-pulse-6-passenger", name: "ActivEV Pulse", model: "6 Passenger", price: 10995, status: "Published", description: "Flexible six-passenger seating and approachable electric performance.", range: "Up to 35 mi", seats: "6 passengers", highlights: ["Lithium power", "Digital display", "Extended seating"], color: "green" },
];
